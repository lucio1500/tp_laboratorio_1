...
/** \brief Permite obtener un elemento de la lista recibiendo el indice donde se encuentra este.
 *
 * \param this LinkedList* Puntero a la lista
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    returnAux=1;
        if(ll_len(this2)>0)
        {
            ...
            {
                auxElementThis2=ll_get(this2,i);
                returnAux=ll_contains(this,auxElementThis2);
                if(returnAux==0)
                {
                    break;
                }
...
int ll_sort(LinkedList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this!=NULL && (order==0 || order==1)&& pFunc!=NULL)
    {
        ...
        for(int i=0;i<len-1;i++)
        {
            ...
            {
            pElement=ll_get(this,i);
            pElement1=ll_get(this,j);
                if(pElement!=NULL && pElement1!=NULL)
                {
                    retorno=pFunc(pElement,pElement1);
                        switch(retorno)
                        {
                            case -1:
                                //pElement es menor a pElement1
                                if(order==0)//[1] Indica orden ascendente 1-9 - [0] Indica orden descendente 9-1
                                {
                                pAux=pElement;
